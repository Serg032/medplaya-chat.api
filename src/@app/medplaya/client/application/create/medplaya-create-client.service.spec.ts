...
describe('MedplayaCreateClientService', () =>

{
    let service: MedplayaCreateClientService;
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(MedplayaCreateClientService);
    });

    describe('main', () =>
    {
        test('MedplayaCreateClientService should be defined', () =>
        {
