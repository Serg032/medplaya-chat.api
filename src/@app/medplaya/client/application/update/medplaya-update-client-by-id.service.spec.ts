...
describe('MedplayaUpdateClientByIdService', () =>
{
    let service: MedplayaUpdateClientByIdService;
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(MedplayaUpdateClientByIdService);
    });

    describe('main', () =>
    {
        test('MedplayaUpdateClientByIdService should be defined', () =>
        {
