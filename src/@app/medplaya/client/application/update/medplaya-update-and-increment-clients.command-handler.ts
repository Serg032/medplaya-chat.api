...
import { MedplayaUpdateAndIncrementClientsCommand } from '@app/medplaya/client';
...
@CommandHandler(MedplayaUpdateAndIncrementClientsCommand)
export class MedplayaUpdateAndIncrementClientsCommandHandler implements ICommandHandler<MedplayaUpdateAndIncrementClientsCommand>
{
    constructor(
        private readonly updateClientsService: MedplayaUpdateAndIncrementClientsService,
    ) {}

    async execute(command: MedplayaUpdateAndIncrementClientsCommand): Promise<void>
    {
